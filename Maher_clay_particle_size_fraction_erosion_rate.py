##Maher_clay_particle_size_fraction_erosion_rate.py
##=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
## Makes plots of clay particle size as a function of erosion rate for different runoffs following Maher and Chamberlain 2014 Science, 
